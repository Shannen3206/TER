...
public class TERtest {
    public static void main(String[] args) {
        ...
        System.out.println("Number of calls to beam search: " + TERcalc.numBeamCalls());
        System.out.println("Number of segments scored: " + TERcalc.numSegsScored());
        System.out.println("Number of shifts tried: " + TERcalc.numShiftsTried());
    }
